...
LIB2GEOM_FLAGS="-D2GEOM_BUILD_SHARED=ON -D2GEOM_CYTHON_BINDINGS=OFF -D2GEOM_BOOST_PYTHON=OFF -D2GEOM_TOYS=OFF -D2GEOM_USE_GPL_CODE=ON -D2GEOM_PERFORMANCE_TESTS=OFF"
